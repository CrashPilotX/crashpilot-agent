...
```bash
docker run -d --name crashpilot --restart unless-stopped --stop-timeout 30 \
  --pid host --privileged -p 7878:7878 \
  -v crashpilot-data:/var/lib/crashpilot -v /etc/machine-id:/etc/machine-id:ro \
